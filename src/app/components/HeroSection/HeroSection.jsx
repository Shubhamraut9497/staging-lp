...
// import heroImg from "../publ/img/hero.png";

const HeroSection = ({ title, subtitle, banner }) => {
  const orig = "https://app.shootorder.com/assets/";
  const imgFormat = ".jpg";
  const bgBanner = {
    backgroundImage: `url(${orig + banner + imgFormat})`,
  ...
  return (
    <>
      <div
        className=" py-32 mx-auto xl:flex relative  "
        style={bgBanner}
      >
        <div className="bg-overlay absolute z-10 bg-neutral-950 opacity-25 w-full h-full "></div>
        <div className="container flex flex-wrap lg:flex-nowrap px-4 lg:px-24 lg:text-left text-center ">
          <div className="flex items-center  p-8 z-30 lg:w-2/3 z-20 ">
            <div>
          ...
          <div className=" border rounded  bg-white shadow-lg rounded-xl z-20 w-full lg:w-1/3 overflow-hidden">
            <div className="">
              <h1 className="heading-text pt-4 pb-1 text-center text-3xl font-bold text-red-900 ">
                Enquire Now
              </h1>
              <form
                className="px-6 pt-6 "
              ...
              >
                ...
                <div className="mb-4 w-full  ">
                  <input
                    ...
                    type="text"
                    className="form-control p-1.5 w-full shadow-xl rounded-xl focus:outline-none"
                    id="fullname"
                    name="fullname"
                    required
                  />
                ...
                <div className="mb-4">
                  <input
                    ...
                    name="mobile"
                    maxLength="10"
                    onKeyPress={(e) => e.charCode > 47 && e.charCode < 58}
                    required
                  />
                </div>
                <div className="mb-4 grid grid-cols-2 gap-4">
                  <select
                    className="form-select action p-1.5 w-full shadow-xl rounded-xl focus:outline-none"
                    name="location"
                    id="location"
                    required
                    aria-label="State"
                  ...
                  <select
                    className="form-select p-1.5 w-full shadow-xl rounded-xl focus:outline-none"
                    name="branch"
                    id="branch"
                    required
                    aria-label="Clinic"
                ...
                <div className="mb-4">
                  <div className="flex items-center justify-center">
                    <input
                      ...
                      checked
                    />
                    <label className="ml-2" htmlFor="exampleCheck1">
                ...
                <button
                  type="submit"
                  id="form-submit"
                  className="btn btn-oasis-submit w-full py-2 mb-3 bg-red-600 text-white font-semibold rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                >
                  Request call back!
                </button>
              </form>
              <div className="form-footer text-center px-6 py-4 bg-orange-200 ">
                <h5>
      ...
      {/* We Can Make new Component for the below part  */}
    </>
  );
};
